    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50">
      ...
      <main className="w-full">
        ...
        <section id="contribute" className="w-full max-w-6xl mx-auto py-16 md:py-20 px-4 md:px-6">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-10 max-w-2xl">Join the community and help shape the future of auth scaffolding. Whether you're adding features, templates, or documentation—all contributions are welcome.</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-6 border border-slate-200 dark:border-slate-800">
              ...
              <a href="https://github.com/Oludefiyinfoluwa06/auth-boilerplate-cli" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-semibold">
                View on GitHub →
              </a>
            </div>
            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-6 border border-slate-200 dark:border-slate-800">
              ...
              <a href="https://github.com/Oludefiyinfoluwa06/auth-boilerplate-cli/issues" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-semibold">
                Report Issue →
              </a>
            </div>
            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-6 border border-slate-200 dark:border-slate-800">
              ...
              <a href="https://github.com/Oludefiyinfoluwa06/auth-boilerplate-cli/discussions" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-semibold">
                Join Discussion →
              </a>
            </div>
          </div>
